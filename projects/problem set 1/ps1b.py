...
semi_annual_raise = float(input("Entyer the semi-annual rase, as a decimal: "))
...
while(current_savings < total_down): #Saving will repeat monthly until your current savings surpass the needed down payment.
    num_months += 1 #increments to the next month. We start on month 1.    
    ...
    if(num_months%6 == 0): #This will occur every 6 loops.
